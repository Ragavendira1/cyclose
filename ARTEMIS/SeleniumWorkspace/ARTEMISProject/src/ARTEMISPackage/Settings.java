...
public class Settings{
	...
	public static String Generate_Test_Log = "";
	...
	public static void Settings() {
		try {
			...
			Generate_Test_Log = FunctionLibrary.getConfigValue("Generate Test Log").trim();
			Maximum_Error_Recovery_Attempts = Integer.parseInt(FunctionLibrary.getConfigValue("Maximum Error Recovery Attempts").trim());
			DateFormat = FunctionLibrary.getConfigValue("Date Format").trim();
